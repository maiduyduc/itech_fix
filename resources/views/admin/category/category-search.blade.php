        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                <div class="border-bottom pb-4 mb-4 d-lg-flex align-items-center justify-content-between">
                    @include('partials.dashboard.category-header', ['name' => 'Trang chủ','name_page' => 'Danh mục khóa học' ,'key' => 'Tìm kiếm'])
                    <div>
                ...
                <div class="card mb-4">
                    <div class="card-header border-bottom-0">
                      ...
                      <i class="fe fe-search"></i>
                            ...
                            <input type="search" value="{{ $input }}" name="name" class="form-control pl-6"
                        ...
                        <table class="table mb-0 text-nowrap">
                            ...
                            @foreach($names as $name)
                                <tr>
                                    ...
                                    <td class="align-middle">{{ $name->created_at }}</td>
                                    <td class="align-middle">{{ $name->updated_at }}</td>
                            ...
                            <span class="dropdown-menu" aria-labelledby="courseDropdown3">
                              <span class="dropdown-header">Hành động</span>
                                                <a class="dropdown-item"
                                                   href="{{ route('categories.edit', ['id'=>$name->id]) }}"><i
                                                        class="fe fe-edit dropdown-item-icon"></i>Sửa</a>
                                                <a class="dropdown-item action_delete"
                                                   data-url="{{ route('categories.delete', ['id'=>$name->id]) }}"
                                                   href="#!">
