        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                <div class="border-bottom pb-4 mb-4 d-lg-flex align-items-center justify-content-between">
                    @include('partials.dashboard.category-header', ['name' => 'Trang chủ','name_page' => 'Danh mục khóa học' ,'key' => 'Thùng rác'])
{{--                    <div>--}}
...
{{--                                    <td class="align-middle">{{ $category->updated_at }}</td>--}}
                            ...
                            <span class="dropdown-menu" aria-labelledby="courseDropdown3">
                              <span class="dropdown-header">Hành động</span>
                                                ...
                                                >
                                                    <i class="fe fe-refresh-cw dropdown-item-icon"></i>Khôi phục</a>
                                                <a class="dropdown-item action_delete"
                                                   data-url="{{ route('categories.forceDelete', ['id'=>$category->id]) }}"
                                                   href="#!">
