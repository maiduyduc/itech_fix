        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                <div class="border-bottom pb-4 mb-4 d-lg-flex align-items-center justify-content-between">
                    @include('partials.dashboard.course-header', ['name' => 'Trang chủ','name_page' =>'Danh sách hóa học' ,'key' => 'Danh sách hóa học'])
                    <div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                <div class="card rounded-lg">
                    <div class="p-4 row">
                        <form action="{{ route('courses-admin.search') }}"
                              method="get"
                            class="d-flex align-items-center col-12 col-md-12 col-lg-12">
                       <span class="position-absolute pl-3 search-icon">
                      <i class="fe fe-search"></i>
                      </span>
                            <input type="search" name="name" class="form-control pl-6" placeholder="Tìm khóa học"/>
                        </form>
                    </div>
                    <div>
                            ...
                            <div class="tab-pane fade show active" id="courses" role="tabpanel"
                                ...
                                <div class="table-responsive border-0 overflow-y-hidden">
                                            ...
                                            <tr>
                                                       ...
                                                       class="text-inherit">
                                                        <div class="d-lg-flex align-items-center">
                                                            ...
                                                            <div class="ml-lg-3 mt-2 mt-lg-0">
                                                                ...
                                                                <span
                                                                    class="text-inherit">Cập nhật lần cuối: {{$course->updated_at}}</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </td>
                                                <td class="align-middle border-top-0">
                                                    <div class="d-flex align-items-center">
                                                        <h5 class="mb-0">{{ optional($course->category)->name }}</h5>
                                                    </div>
                                                </td>
                                                <td class="align-middle border-top-0">{{ number_format($course->subscriptions)  }}</td>
                                                <td class="align-middle border-top-0">
                                  <span class="dropdown">
                                  ...
                                  <a class="dropdown-item"
                                     href="{{ route('courses-admin.edit', ['id'=>$course->id]) }}"><i
                                          class="fe fe-edit dropdown-item-icon"></i>Sửa</a>
                                      <a class="dropdown-item action_delete"
                                         data-url="{{ route('courses-admin.delete', ['id'=>$course->id]) }}"
                                         href="">
