    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-arrow" aria-labelledby="navbarBrowse">
                @foreach($categories_limit as $categoryParent)
                    <li class="dropdown-submenu dropright">
                        <a class="dropdown-item dropdown-list-group-item"
                           href="{{ route('courses.list',['slug'=>$categoryParent->slug, 'id'=>$categoryParent->id]) }}">
                            {{ $categoryParent->name }}
                        </a>
                        @include('partials.index.children-menu', ['categoryParent'=>$categoryParent])
                    </li>
                @endforeach
            </ul>
        </li>
...
{{--          class="mt-3 mt-lg-0 ml-lg-3 d-flex align-items-center"--}}
          class="form-inline">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a class="dropdown-item" href="{{ route('register') }}">
                                <i class="fe fe-unlock mr-2"></i>Đăng ký
                            </a>
                        </li>
                        <li>
