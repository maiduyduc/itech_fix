        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                    <div>
                        <h1 class="mb-0 text-white display-4">Danh sách khóa học</h1>
                    </div>
                </div>
            </div>
        </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <ul class="mb-3 list-inline">
                                                        <li class="list-inline-item">
                                                            Lượt đăng ký: {{ number_format($course->subscriptions) }}
                                                        </li>
                                                    </ul>
                                                    <div class="lh-1">
                                    ...
                                    <div class="card mb-4 card-hover">
                                        <div class="row no-gutters">
                                            <a class="col-12 col-md-12 col-xl-3 col-lg-3 bg-cover img-left-rounded"
                                               style="background-image: url({{ $course->image_path }});" href="#!">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <ul class="mb-5 list-inline">
                                                        <li class="list-inline-item">
                                                            ...
                                                            k&yacute;: {{ number_format($course->subscriptions) }}
                                                        </li>
                                                    </ul>
                                                    <div class="lh-1">
                                                        <span class="font-size-xs text-muted"></span>
                                                        <span
                                                            class="text-warning">{{ optional($course->category)->name }}</span>
                                                    </div>
                                                    <div>
                                                    </div>
                                                </div>
